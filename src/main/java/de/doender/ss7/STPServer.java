 ...
 *
 */
public class STPServer implements MAPDialogListener, MAPServiceSupplementaryListener, MAPServiceMobilityListener
{
    ...
    private void initSCTP(IpChannelType channelType) throws java.io.IOException, java.lang.Exception {
        ...
        this.sctpManagement.addAssociation(HLR_IP, HLR_STP_PORT, STP_IP, STP_HLR_PORT, HLR_ASSOCIATION_NAME, channelType, null);
    }
    ...
    private void initM3UA() throws java.lang.Exception {
        ...
        this.serverM3UAMgmt.createAs("AS1", Functionality.AS, ExchangeType.SE, IPSPType.CLIENT, rc, trafficModeType, 1, null);
        this.serverM3UAMgmt.createAspFactory("ASP1", HLR_ASSOCIATION_NAME);

        Asp asp = this.serverM3UAMgmt.assignAspToAs("AS1", "ASP1");

        serverM3UAMgmt.addRoute(STP_SPC, HLR_SPC, 3, "AS1");
    ...
    private void initSCCP() throws java.lang.Exception {
        ...
        this.sccpStack.getRouter().addMtp3ServiceAccessPoint(1, 1, HLR_SPC, NETWORK_INDICATOR, 0, "49987654321");
    ...
    private void initTCAP() throws java.lang.Exception {
        ...
        this.tcapStack = new TCAPStackImpl("ClientTCAP", this.sccpStack.getSccpProvider(), HLR_SSN);
    ...
    private void initMAP() throws java.lang.Exception {
        ...
        this.mapStack = new MAPStackImpl("MapStack", this.sccpStack.getSccpProvider(), HLR_SSN);
    ...
    public static void main( String[] args )
    {
        ...
        final STPServer server = new STPServer();

        try {
            server.initializeStack(channelType);
            Thread.sleep(10000);
            server.serverM3UAMgmt.start();
            server.serverM3UAMgmt.startAsp("ASP1");
